module.exports = {
  PREMATURE_GRAB_MESSAGES : [
    ...
    (username) => `@${username} are we there yet? No. The Black Diamond is still in the case!`,
    (username) => `@${username} said "let me speedrun this heist." The diamond isn't even in play yet!`,
    (username) => `@${username} showing up to the heist before the heist starts. Very Leeroy Jenkins of you!`,
    (username) => `@${username} out here grabbing like it's Black Friday. The diamond isn't on the floor yet!`,
    (username) => `@${username} hit !grab so fast they time traveled. Unfortunately the diamond is still in the case!`,
    (username) => `Early bird gets the worm, @${username}. But this is a diamond heist, not a nature documentary. Wait for the drop!`,
    (username) => `@${username} said "I am speed." The Black Diamond said "not yet."`,
    (username) => `@${username} showing the same energy as someone pressing the elevator button repeatedly. The diamond isn't down yet!`,
    (username) => `There's no diamond on the floor, @${username}. You absolute golden retriever you!`,
    (username) => `@${username} jumped the gun so hard they landed in yesterday. The diamond drops when it drops!`,
  ],
  ...
  POST_EVENT_MESSAGES: [
    ...
    // B) Nostalgia
    (username, command) => `💎 @${username} really said "one more heist for old times' sake." I'm not immune to this. Unfortunately the event is over. Sigma won!`,
    (username, command) => `💎 @${username} typed ${command} and felt something. I, the narrator, felt something too. It doesn't matter. The event is over. Sigma Collective won.`,
    ...
    (username, command) => `💎 @${username} misses the heist. This changes nothing. Sigma Collective won. The Black Diamond is retired.`,
    (username, command) => `💎 @${username} typed ${command} and stared at the screen for a moment. It was a good run. Sigma won though. It's over!`,

    // C) Just wants to play
    (username, command) => `💎 @${username} said "I just want to do one steal." The answer is no. Sigma won. The event is over!`,
    ...
    (username, command) => `💎 @${username} said "the game never ends in my heart." I say "Sigma Collective won." Both things are true.`,
    ...
    (username, command) => `💎 @${username} said "one more game" like it's 2am on a school night. The event is over. Sigma Collective won. I'm going to bed.`,
  ...
  TOURNEY_NOT_REGISTERED_MESSAGES: [
    ...
    (username) => `@${username} typed !tourney. The system searched for their faction. Found nothing. Because they never joined. Because the event is over. Sigma won. My condolences.`,
    ...
    (username) => `@${username} typed !tourney with the confidence of someone who participated. They did not participate. Sigma Collective won!`,
  ...
  GRAB_MESSAGES : [
    ...
    (username, factionName) => `💎 @${username} has picked up the Black Diamond. ${factionName} has entered the game. Press F to pay respects to everyone else.`,
  ...
  GRAB_UNAVAILABLE_MESSAGES : [
    ...
    (username) => `@${username} thought they were early. They were late. The diamond is held. This is the way.`,
    ...
    (username) => `The diamond has been claimed, @${username}. You were this close. This 👌 close!`,
    (username) => `Sorry @${username}, the Black Diamond is currently out of stock. Would you like to be notified when it drops again?`,
    (username) => `@${username} pulled up to an empty floor. Someone got here before you. Touch grass and try again next drop.`,
  ...
  STEAL_SUCCESS_MESSAGES : [
    ...
    (username1, username2) => `💎 @${username1} pulled the Thanos snap on @${username2}'s diamond hold. And just like that, it was gone.`,
    ...
    (username1, username2) => `💎 @${username1} pulled off the Italian Job on @${username2}. Clean, fast, no witnesses!`,
  ...
  STEAL_FAIL_MESSAGES : [
    ...
    (username1, username2) => `❌ @${username1} said hold my beer and attempted the steal. @${username2} held the diamond instead. Much more valuable.`,
    ...
    (username1, username2) => `❌ @${username1} came in like a wrecking ball! @${username2} was an immovable object. Physics wins. Diamond stays!`,
  ...
  STEAL_DROP_MESSAGES : [
    ...
    (username1, username2) => `⚠️ @${username1} and @${username2} really said "none shall pass" to each other simultaneously. The diamond said "I'll pass myself then." Floor!`,
  ...
  STEAL_INVALID_MESSAGES : [
    ...
    (username1, username2) => `❌ @${username1} said @${username2} was sus. The crew voted. @${username2} was not the impostor. +1 point to the innocent.`,
    ...
    (username1, username2) => `❌ @${username1} pointed at @${username2} like the Spider-Man meme. Wrong person. @${username2} collects +1 for the confusion.`,
    ...
    (username1, username2) => `❌ @${username1} said "it's giving diamond holder" about @${username2}. It was not giving diamond holder. +1 to @${username2}.`,
    ...
    (username1, username2) => `❌ @${username1} went full 67 on @${username2} and missed entirely. Different person, different diamond. +1 to @${username2} for the chaos tax.`,
  ...
  STEAL_TEAMMATE_MESSAGES : [
    ...
    (username1, username2) => `❌ @${username1} just targeted their own teammate. This is not Among Us. @${username2} is not the impostor. They're on your team!`,
    ...
    (username1, username2) => `❌ @${username1} vs @${username2}. Same faction. Same team. Same collective facepalm from the crew.`,
    ...
    (username1, username2) => `❌ @${username1} activated PvP in a PvE zone. @${username2} is your ally. Read the room.`,
    ...
    (username1, username2) => `❌ @${username1} this is a team sport. @${username2} is on your team. This has been a public service announcement.`,
    (username1, username2) => `❌ A moment of confusion. @${username1} tries to steal from @${username2}, but shared objectives intervene.`,
    (username1, username2) => `❌ @${username1} really chose violence against @${username2} of all people. Their own faction. Their own crew. Their own problem now!`,
  ...
  PASS_SUCCESS_MESSAGES: [
    ...
    (username1, username2, factionName) => `💎 @${username1} yeeted the Black Diamond to @${username2}. ${factionName} catches. Security system loses track. Perfect!`,
    ...
    (username1, username2, factionName) => `💎 @${username1} to @${username2}. The ✨pass era✨ of ${factionName} continues.`,
  ...
  PASS_NOT_HOLDER_MESSAGES: [
    ...
    (username) => `❌ @${username} manifested a pass. Unfortunately manifestation requires actually holding the Black Diamond first!`,
  ...
  PASS_BACK_MESSAGES: [
    ...
    (username1, username2) => `❌ @${username1} tried to return to sender. @${username2} is not accepting returns at this time.`,
    ...
    (username1, username2) => `❌ @${username1} attempted a boomerang pass to @${username2}. The Black Diamond doesn't do boomerangs.`,
    ...
    (username1, username2) => `❌ @${username1} tried to undo the pass like it's Ctrl+Z. @${username2} already moved on. So should you.`,
  ...
  FLASHPOINT_OWN_FACTION_MESSAGES: [
    (username, holder) => `⚠️🚨 @${username} detonates a Flashpoint! On their own faction. While @${holder} was holding the diamond. We're so going to talk about this!!`,
  ...
  PASS_ENEMY_FACTION_MESSAGES: [
    (username, target, factionName) => `💎⁉️ @${username} passes the Black Diamond to @${target} of ${factionName}. Across faction lines. Voluntarily. The narrator is choosing not to comment!`,
    (username, target, factionName) => `💎⁉️ The Black Diamond has been passed to @${target} of ${factionName}... by @${username}, their rival! This is apparently happening. +2 to ${factionName}.`,
    (username, target, factionName) => `💎⁉️ @${username} hands the diamond to ${factionName}'s @${target}. The security system doesn't even know how to log this. +2 points to ${factionName}.`,
    (username, target, factionName) => `💎⁉️ @${username} just passed to the enemy. This wasn't in the briefing. None of this was in the briefing!!`,
    (username, target, factionName) => `💎⁉️ The narrator has covered heists in seventeen museums across four continents. @${username} passing to @${target} of ${factionName} is a first. +2 to ${factionName}.`,
    (username, target, factionName) => `💎⁉️ @${username} to @${target}. Different factions. The chat has questions! The crew has questions! I HAVE QUESTIONS! +2 to ${factionName}.`,
    (username, target, factionName) => `💎⁉️ @${username} what are you doing, @${username}? WHAT ARE YOU DOING?! @${target} of ${factionName} now has the diamond and +2 points. Congratulations to everyone involved!`,
    (username, target, factionName) => `💎⁉️ @${username} passes to @${target}. The enemy. @${target}. Of ${factionName}. We're going to need a moment!!`,
    (username, target, factionName) => `💎⁉️ Bold. Possibly genius. Or maybe not. @${username} hands the Black Diamond directly to ${factionName}'s @${target}. +2 points. The crew is filing paperwork!`,
    (username, target, factionName) => `💎⁉️ @${username} pulls an Anakin. @${target} of ${factionName} is now holding the Black Diamond. This is where the fun begins. +2 points.`,
    (username, target, factionName) => `💎⁉️ @${username}: "I am once again passing the Black Diamond to the enemy." @${target} of ${factionName} accepts. +2 points to ${factionName}.`,
    (username, target, factionName) => `💎⁉️ @${username} has chosen chaos. Like a true Loki. The Black Diamond lands with @${target} of ${factionName}. +2 points. You're welcome, everyone!`,
    (username, target, factionName) => `💎⁉️ Plot twist! M. Night Shyamalan could never! @${username} passes to ${factionName}'s @${target}. +2 points. The audience didn't see that coming.`,
    (username, target, factionName) => `💎⁉️ @${username} said "it's not about the points, it's about sending a message." @${target} of ${factionName} received it. +2 points.`,
    (username, target, factionName) => `💎⁉️ @${username} has gone full uno reverse on their own faction! @${target} of ${factionName} didn't even have to steal it. +2 points just landed in their lap!`
  ],
